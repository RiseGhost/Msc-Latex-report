...
Para transferir o jogo realizado no contexto desta dissertação, pode \href{https://github.com/RiseGhost/PORT-0/releases}{cliquar aqui}, onde pode encontrar um conjunto de versões para \textit{download}, sendo recomendado transferir a ultima versão.

\subsection{Organização do Documento}

O presente documento encontra-se estruturado em seis capítulos, os quais refletem as diferentes etapas do ciclo de desenvolvimento desta dissertação, desde o seu enquadramento, à concetualização e fundamentação teórica até à implementação, testagem e reflexão crítica dos resultados obtidos. A organização dos capítulos apresenta-se da seguinte forma:
...
Implementação de efeitos sonoros e narração & 1 semana \\ \hline
