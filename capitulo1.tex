...
O presente documento encontra-se estruturado em seis capítulos, os quais refletem as diferentes etapas do ciclo de desenvolvimento desta dissertação, desde do seu enquadramento, à concetualização e fundamentação teórica até à implementação, testagem e reflexão crítica dos resultados obtidos. A organização dos capítulos apresenta-se da seguinte forma:
