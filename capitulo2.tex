...
O jogador terá de fazer a instalação de uma infraestrutura passando pela várias etapas, como montagem, conexão de cabos e configuração de equipamentos.
  \begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{images/DataCenter1.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{images/PCBuildSimulator_BuildPC.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{images/Startu - humanos.png}
...
criação de jogos com objetivos educacionais. Embora o projeto desenvolvido se defina 
especificamente como um adding game, e não como um jogo sério tradicional, a metodologia
