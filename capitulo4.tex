...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagramas/diagrama_game.png}
...
No diagrama, é possível observar que no sistema de combate, existe uma recompensa para o jogador. Embora essa recompensa faça parte da idealização do sistema de combate, ela não foi implementada, devido à complexidade.
...
O jogador têm de agir rápido para conseguir restaurar os ganhos periódicos, caso contrário, pode perder uma grande quantidade de dinheiro, o que pode levar a uma situação de falência, impossibilitando o pagamento dos custos periódicos, o que leva o jogador a perder o jogo.
...
\begin{figure}[H]
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Blender/CenarioViewPort1.png}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Blender/CenarioViewPort2.png}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Blender/CenarioViewPort3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{Blender/CenárioRender.png}
...
\begin{figure}[H]
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Blender/CanhaoViewPort1.png}
         \caption{Cenário Vista de \textit{ViewPort} 1}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Blender/CanhaoViewPort2.png}
         \caption{Cenário Vista de \textit{ViewPort} 2}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Blender/CanhaoViewPort3.png}
         \caption{Cenário Vista de \textit{ViewPort} 3}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{Blender/CanhaoRender.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{images/MiniGameVFX.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{images/HomeMenuEfeito.png}
...
\begin{figure}[H]
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Presonagem/FurryFront.png}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Presonagem/FurryBack.png}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Presonagem/FurryLeft.png}
     \end{subfigure}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Presonagem/FurryRight.png}
     \end{subfigure}
     \hspace{0.5cm} % Espaço manual para centralizar a quinta imagem
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{Presonagem/Furrytop.png}
     \end{subfigure}
