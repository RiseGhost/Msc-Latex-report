...
\begin{itemize}
    ...
    \item \textbf{Melhorias de Usabilidade e Acessibilidade (UX/UI):} Corrigir os problemas identificados no estudo qualitativo de UX (Tabela 5.1), aperfeiçoando os controlos e indicação de mira do canhão, ajustando a câmara ortográfica com zoom dinâmico e adicionando indicadores visuais e sonoros persistentes para notificações de e-mail e atalhos de teclado.
